...
export const DEMO_PERSONAS: PersonaDetail[] = [
  ...
  /** Staging DB id alias — same traits as persona-alex-lab-impatient (from-pack resolve). */
  {
    id: 'persona-alex-lab-ungeduldig-msdfje0b',
    name: 'Alex Lab Ungeduldig',
    role: 'eBike-Besitzer · Lab impatient clone',
    projectId: 'proj-audion-core',
    status: 'ready',
    ...
    age: '35–44',
    location: 'Deutschland',
    bio: 'Staging-DB-Alias für persona-alex-lab-impatient (paths.personaLabImpatientDbPersonaId).',
    gender: null,
    attentionSpan: 'Sehr kurz; nach 1–2 verwirrenden Filterzuständen Abbruch',
    colorPalette: ['#1a2332', '#c8d4e0', '#5a7a6a'],
    mediaAffinity: 0.45,
  ...
  /** Staging DB id alias — same traits as persona-sam-lab-patient. */
  {
    id: 'persona-sam-lab-geduldig-msdroy3t',
    name: 'Sam Lab Geduldig',
    role: 'eBike-Besitzer · Lab patient clone',
    projectId: 'proj-audion-core',
    status: 'ready',
    ...
    age: '28–38',
    location: 'Deutschland',
    bio: 'Staging-DB-Alias für persona-sam-lab-patient (paths.personaLabPatientDbPersonaId).',
    gender: null,
    attentionSpan: 'Lang; prüft Drive Unit → Akku → Display vor Abbruch',
    colorPalette: ['#243018', '#e8e2d4', '#7a8f5a'],
    mediaAffinity: 0.55,
