...
describe('audion chat workspace', () => {
  it('puts persona + Share/History in the topbar and Voice/Video by the composer', () => {
    ...
    expect(form?.querySelector('.audion-chat-composer-row .audion-chat-composer-actions')).toBeTruthy()
    expect(form?.querySelector(':scope > .audion-chat-composer-actions')).toBeNull()
