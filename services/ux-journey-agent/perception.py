...
def perception_prompt_extension(
    *,
    ...
    return (
        ...
        "VISION GROUND TRUTH: Der Screenshot (mit Bounding Boxes) ist die Wahrheit für "
        "sichtbare UI. Nav-Labels nur klicken, wenn sie im Screenshot und/oder in noticed "
        "sichtbar sind. Mega-Menu: zuerst Hover/Look auf den Opener, warten bis Unterpunkte "
        "sichtbar sind, DANN Ziel klicken — denselben Opener nicht nach Fehlschlag thrashen.\n"
