...
from audion_agent.browser.cloud.views import CloudBrowserParams
from audion_agent.config import CONFIG
from audion_agent.utils import _log_pretty_path, logger
...
# Using constants from central location in audion_agent.config
...
class BrowserProfile(BrowserConnectArgs, BrowserLaunchPersistentContextArgs, BrowserLaunchArgs, BrowserNewContextArgs):
	...
	proxy: ProxySettings | None = Field(
		default=None,
		description='Proxy settings. Use audion_agent.browser.profile.ProxySettings(server, bypass, username, password)',
	)
