...
if _get_subcommand() == 'cloud':
	...
	if cloud_idx + 1 < len(sys.argv) and sys.argv[cloud_idx + 1] in ('--help', '-h'):
		from audion_agent.skill_cli.commands.cloud import handle_cloud_command
...
def _migrate_legacy_files() -> None:
	...
	from audion_agent.skill_cli.utils import migrate_legacy_paths
...
def main() -> int:
	...
	if args.command == 'profile':
		from audion_agent.skill_cli.profile_use import run_profile_use
	...
	if args.command == 'setup':
		from audion_agent.skill_cli.commands import setup
	...
	if args.command == 'doctor':
		from audion_agent.skill_cli.commands import doctor
	...
	if args.command == 'tunnel':
		from audion_agent.skill_cli import tunnel
	...
	if args.connect:
		from audion_agent.skill_cli.utils import discover_chrome_cdp_url
