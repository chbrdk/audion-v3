...
from audion_agent.llm.messages import BaseMessage, ContentPartTextParam, SystemMessage
from audion_agent.llm.schema import SchemaOptimizer
from audion_agent.llm.vercel.serializer import VercelMessageSerializer
...
class ChatVercel(BaseChatModel):
	...
	Examples:
		```python
	        from audion_agent import Agent, ChatVercel
