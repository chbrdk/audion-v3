...
export UX_JOURNEY_OPENAI_MODEL="${UX_JOURNEY_OPENAI_MODEL:-gpt-5.4-nano}"
...
echo "  max_failures=${UX_JOURNEY_MAX_FAILURES} scorecard=${UX_JOURNEY_SCORECARD} video_transcode=${UX_JOURNEY_VIDEO_TRANSCODE} openai_model=${UX_JOURNEY_OPENAI_MODEL}"
