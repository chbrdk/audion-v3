...
V1: Vorlagen + Blockliste + Canvas + Compile → Study (alle 10 Graphen). Live-Gates: Agent `gateSignals` + Canvas-Cursor (url/title/frustration); volle Mid-Run-Replanung = später.
