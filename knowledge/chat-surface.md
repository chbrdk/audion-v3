...
| Composer | Starts narrow (~28rem), expands to ~52rem on hover/focus/`is-expanded`; brand underline; icon-only send (`.chat-send-icon`); Voice / Video icon toggles left of textarea (`.audion-chat-composer-actions`) |
