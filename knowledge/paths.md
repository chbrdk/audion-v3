...
- Persona chat completion cap: `AI_CHAT_MAX_TOKENS` → OpenAI `max_completion_tokens` (default **500**, SoT `paths.chatCompletionMaxTokens`) — adaptive prompt `knowledge/adaptive-persona-chat-2026-08-27.md`
