...
- Persona chat `max_tokens`: `AI_CHAT_MAX_TOKENS` (default **500**, SoT `paths.chatCompletionMaxTokens`) — adaptive prompt `knowledge/adaptive-persona-chat-2026-08-27.md`
